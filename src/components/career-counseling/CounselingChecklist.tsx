        ...
        <div className="grid lg:grid-cols-3 gap-6 lg:gap-8 max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="relative z-10">
              {/* Title */}
              <div className="mb-6">
                <div className="inline-flex p-3 rounded-xl bg-gradient-to-br from-orange-500 to-yellow-600 shadow-lg mb-3">
              ...
              <ul className="space-y-3">
                {simpleSteps.map((item, index) => (
                  <motion.li
                    ...
                    className="flex items-start gap-3 group"
                  >
                    <div className="flex-shrink-0 w-8 h-8 rounded-full bg-gradient-to-br from-orange-500 to-yellow-600 flex items-center justify-center group-hover:scale-110 transition-transform">
