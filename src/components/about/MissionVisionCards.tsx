...
const MissionVisionCards = () => {
  return (
    <section className="relative py-16 sm:py-20 lg:py-28 bg-gradient-to-b from-white via-yellow-50/30 to-yellow-50/30 overflow-hidden">
      {/* Decorative wave top */}
      ...
      <motion.div
        ...
        className="absolute top-40 right-20 w-96 h-96 bg-gradient-to-br from-yellow-300/30 to-yellow-300/30 rounded-full blur-3xl"
      />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-semibold text-yellow-700">Our Purpose</span>
          </motion.div>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8 max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            whileHover={{ y: -8, scale: 1.02 }}
            className="group relative bg-gradient-to-br from-amber-50 via-yellow-50 to-yellow-50 rounded-3xl p-8 sm:p-10 lg:p-12 shadow-xl hover:shadow-2xl transition-all duration-300 border border-yellow-200 overflow-hidden"
          >
            {/* Background decorative pattern */}
            <div className="absolute inset-0 opacity-10">
              <Compass className="absolute top-10 right-10 w-48 h-48 text-yellow-600" strokeWidth={0.5} />
            </div>
            ...
            <motion.div
              whileHover={{ rotate: 360, scale: 1.1 }}
              transition={{ duration: 0.6 }}
              className="inline-flex p-4 rounded-2xl bg-gradient-to-br from-yellow-500 to-amber-600 shadow-lg mb-6 relative z-10"
            >
            ...
            <p className="text-gray-700 text-base sm:text-lg leading-relaxed relative z-10">
              ...
              <span className="font-semibold text-yellow-700">creative bounce, verve and network</span> seamlessly to
              even out challenges associated with{" "}
              <span className="font-semibold text-yellow-700">student placements and visas</span> in selected countries
              around the globe; with our{" "}
              <span className="font-semibold text-yellow-700">happiness tied to each student's satisfaction</span>
            </p>

            {/* Decorative corner */}
            <div className="absolute bottom-0 right-0 w-32 h-32 bg-gradient-to-tl from-yellow-500/20 to-transparent rounded-tl-full opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          </motion.div>
