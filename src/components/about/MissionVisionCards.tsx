...
const MissionVisionCards = () => {
  return (
    <section className="relative py-16 sm:py-20 lg:py-28 bg-gradient-to-b from-white via-orange-50/30 to-orange-50/30 overflow-hidden">
      {/* Decorative wave top */}
      ...
      <motion.div
        ...
        className="absolute top-40 right-20 w-96 h-96 bg-gradient-to-br from-orange-300/30 to-orange-300/30 rounded-full blur-3xl"
      />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8 max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            whileHover={{ y: -8, scale: 1.02 }}
            className="group relative bg-gradient-to-br from-amber-50 via-orange-50 to-orange-50 rounded-3xl p-8 sm:p-10 lg:p-12 shadow-xl hover:shadow-2xl transition-all duration-300 border border-orange-200 overflow-hidden"
          >
            {/* Background decorative pattern */}
            <div className="absolute inset-0 opacity-10">
