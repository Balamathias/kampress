...
const StrategyValues = () => {
  ...
  return (
    <section className="relative py-16 sm:py-20 lg:py-28 bg-gradient-to-b from-orange-50/30 via-amber-50/50 to-orange-100/50 overflow-hidden">
      {/* Background pattern */}
      ...
      <motion.div
        ...
        className="absolute bottom-20 right-20 w-96 h-96 bg-gradient-to-tl from-orange-400/30 to-orange-400/30 rounded-full blur-3xl"
      />
