  ...
  return (
    <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <Image
          src="/images/hero-bg-slides/slide-5.png"
          alt="Study Abroad"
          fill
          ...
          quality={90}
        />
        <div className="absolute inset-0 bg-gradient-to-r from-blue-900/90 via-indigo-900/85 to-blue-900/90" />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-20 lg:py-28">
        ...
        >
          ...
          <motion.p
            ...
            className="text-lg sm:text-xl lg:text-2xl text-white/95 leading-relaxed mb-8"
          >
            <span className="italic">"Education is the most powerful weapon which you can use to change the world."</span>
            <br />
      ...
      <div className="absolute bottom-0 left-0 right-0">
        <svg viewBox="0 0 1440 120" fill="none" className="w-full h-16 sm:h-20">
          <path d="M0 120L60 110C120 100 240 80 360 70C480 60 600 60 720 65C840 70 960 80 1080 80C1200 80 1320 70 1380 65L1440 60V120H1380C1320 120 1200 120 1080 120C960 120 840 120 720 120C600 120 480 120 360 120C240 120 120 120 60 120H0Z" fill="#FCD34D"/>
        </svg>
      </div>
    </section>
  );
