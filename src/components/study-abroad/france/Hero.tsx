    ...
    <section className="relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 py-20 sm:py-28">
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="relative h-56 sm:h-72 lg:h-96">
            <Image src="/images/hero-bg-slides/slide-4.png" alt="France" fill className="object-cover rounded-xl shadow-2xl ring-1 ring-white/10" priority />
          </motion.div>
        </div>
      </div>
    </section>
