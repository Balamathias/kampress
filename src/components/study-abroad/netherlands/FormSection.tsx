      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-10 items-start">
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-3xl sm:text-4xl font-extrabold">Ready to begin your Netherlands journey?</h2>
            <p className="mt-3 text-white/85 max-w-xl">Book a counseling session to shortlist programmes, understand costs and funding, and plan your application timeline.</p>
          </motion.div>
