...
const PartnerUniversities = () => {
  ...
  return (
    <section className="relative py-16 sm:py-20 lg:py-28 bg-gradient-to-b from-white via-yellow-50 to-orange-50 overflow-hidden">
      {/* Decorative top border */}
      <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-orange-400 via-yellow-400 to-orange-400" />
      ...
      <motion.div
        ...
        className="absolute top-20 right-10 w-96 h-96 bg-gradient-to-br from-orange-300/20 to-yellow-300/20 rounded-full blur-3xl"
      />
      <motion.div
        animate={{
          scale: [1, 1.3, 1],
        ...
        className="absolute bottom-20 left-10 w-96 h-96 bg-gradient-to-tl from-yellow-300/20 to-orange-300/20 rounded-full blur-3xl"
      />
          ...
          {[
            ...
            >
              ...
              <div className="relative mb-4">
                <div className="inline-flex p-3 rounded-xl bg-gradient-to-br from-orange-100 to-yellow-100 group-hover:from-orange-500 group-hover:to-orange-600 transition-all duration-300">
